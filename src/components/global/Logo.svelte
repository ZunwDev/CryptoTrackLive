<script>
  ...
  import { isSearchBarPhoneHidden } from "@store/store";
</script>

<a href={MAIN_PAGE_URL} class="relative flex items-center w-40 mr-auto sm:mr-0 {!$isSearchBarPhoneHidden ? 'hidden' : ''}">
